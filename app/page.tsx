  ...
  return (
    <div className="flex flex-col flex-1 font-sans">
        ...
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
          ...
          {isAuthenticated ? (
            <form action={signOut}>
              <button
                type="submit"
                className="inline-flex h-9 items-center justify-center rounded-full border border-zinc-300 bg-white px-5 text-sm font-medium text-zinc-700 transition-all hover:bg-zinc-50 active:scale-95 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-300 dark:hover:bg-zinc-700"
              >
                Sign Out
              </button>
            </form>
                ...
                <div className="space-y-3">
                    ...
                    {[
                      {
                        ...
                        sender: "Sarah Chen",
                        preview: "Meeting tomorrow at 2pm?",
                      },
                      {
                        platform: "WhatsApp",
                        color: "bg-emerald-100 text-emerald-600 dark:bg-emerald-900/40 dark:text-emerald-400",
                        sender: "Team Group",
                        preview: "Project deadline updated to Friday",
                      },
                      {
                        platform: "Telegram",
                        color: "bg-sky-100 text-sky-600 dark:bg-sky-900/40 dark:text-sky-400",
                        sender: "Dev Channel",
                        preview: "New PR ready for review",
                      },
                      {
                        platform: "Outlook",
                        color: "bg-blue-100 text-blue-600 dark:bg-blue-900/40 dark:text-blue-400",
                        sender: "HR Department",
                        preview: "Quarterly review schedule",
                      },
                    ].map((msg, i) => (
                      <div
                        key={i}
                      ...
                      >
                        <span
                          className={`inline-flex items-center rounded-md px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wider ${msg.color}`}
                        >
                          {msg.platform}
                        </span>
                        ...
                        <div className="flex h-6 w-6 items-center justify-center rounded-full bg-brand-100 text-[10px] text-brand-600 dark:bg-brand-900/40 dark:text-brand-400">
                          AI
                        </div>
                      </div>
                    ))}
                  ...
                  <div className="animate-fade-in-up-delayed mt-2 rounded-xl bg-gradient-to-r from-brand-500 to-accent-500 p-3">
                    ...
                    <p className="mt-1 text-sm font-medium text-white">
                      3 action items, 2 meetings, 1 urgent — all organized.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section
        ...
        id="integrations"
        className="border-y border-zinc-100 bg-zinc-50/50 px-6 py-20 dark:border-zinc-800 dark:bg-zinc-900/50"
      >
        <div className="mx-auto max-w-7xl">
          <div className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-lg text-zinc-600 dark:text-zinc-400">
              One-click connect to the platforms you use every day. Your data
            ...
            {[
              {
                name: "Gmail",
                icon: "✉️",
                desc: "Read, summarize, and organize your inbox with AI.",
                connected: true,
              ...
              },
              {
                name: "WhatsApp",
                icon: "💬",
                desc: "Never miss important messages. Get daily digests.",
                connected: false,
              ...
              },
              {
                name: "Telegram",
                icon: "✈️",
                desc: "Summarize group chats and track action items.",
                connected: false,
              ...
              },
              {
                name: "Outlook",
                icon: "📅",
                desc: "Sync calendar events and emails seamlessly.",
                connected: false,
              ...
              <div
                key={i}
                className={`group relative overflow-hidden rounded-2xl border bg-gradient-to-b ${platform.gradient} ${platform.border} p-6 transition-all duration-300 hover:shadow-lg hover:-translate-y-1`}
              >
                <div className="mb-4 flex items-center justify-between">
                  ...
                  {platform.connected ? (
                    ...
                    <span className="inline-flex items-center gap-1 rounded-full bg-zinc-100 px-3 py-1 text-[11px] font-semibold text-zinc-500 transition-colors group-hover:bg-brand-100 group-hover:text-brand-700 dark:bg-zinc-800 dark:text-zinc-400 dark:group-hover:bg-brand-900/40 dark:group-hover:text-brand-400">
                      Connect
                    </span>
                  )}
                </div>
      ...
      >
        <div className="mx-auto max-w-7xl">
          <div className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-lg text-zinc-600 dark:text-zinc-400">
              From smart summaries to cross-platform search — let AI handle
              the heavy lifting.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Get concise AI-generated summaries of long email threads, group chats, and conversations across all your platforms.",
              },
              {
                icon: "⏰",
                title: "Intelligent Reminders",
                desc: "Never miss a deadline. AI detects action items and deadlines, then sets smart reminders automatically.",
              },
              {
                icon: "🔍",
                title: "Cross-Platform Search",
                desc: "Search across Gmail, WhatsApp, Telegram, and Outlook simultaneously. Find anything instantly.",
              },
              {
                icon: "📊",
                title: "Priority Inbox",
                desc: "AI prioritizes your messages by urgency and importance. Focus on what truly matters each day.",
              },
              {
                icon: "💡",
                title: "Smart Replies",
                desc: "Get context-aware reply suggestions drafted by AI. Respond faster across all your platforms.",
              },
              {
                icon: "📋",
                title: "Daily Digest",
                desc: "Receive a beautifully summarized daily briefing of everything important — emails, messages, events.",
              },
            ].map((feature, i) => (
              <div
                key={i}
                className="group rounded-2xl border border-zinc-200 bg-white p-7 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 dark:border-zinc-800 dark:bg-zinc-900"
              >
                <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-brand-50 text-xl transition-colors group-hover:bg-brand-100 dark:bg-brand-900/30 dark:group-hover:bg-brand-900/50">
                  {feature.icon}
                </div>
                <h3 className="text-lg font-semibold text-zinc-900 dark:text-white">
                  {feature.title}
            ...
            {[
              {
                ...
                desc: "Securely link your Gmail, WhatsApp, Telegram, and Outlook with one click. Your data stays encrypted.",
              ...
              },
              {
                ...
                desc: "Our AI analyzes your conversations to understand priorities, deadlines, and what matters to you.",
              ...
              },
              {
                ...
                desc: "Get daily summaries, smart reminders, and cross-platform search — all in one beautiful dashboard.",
              ...
              <div key={i} className="relative text-center md:text-left">
                {/* Step number badge */}
                <div
                  className={`mx-auto mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br ${step.color} shadow-lg md:mx-0`}
                >
                ...
                {i < 2 && (
                  <div aria-hidden="true" className="absolute -right-4 top-7 hidden h-px w-8 bg-gradient-to-r from-zinc-300 to-transparent md:block dark:from-zinc-700" />
                )}
              </div>
            ))}
          </div>
        ...
        <div className="mx-auto max-w-4xl">
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 px-8 py-16 text-center shadow-2xl dark:from-zinc-950 dark:via-zinc-900 dark:to-zinc-950 sm:px-16">
            ...
            <p className="mx-auto mt-4 max-w-md text-zinc-400">
              Join thousands of professionals already using BrieflyAI to stay
              organized across all their platforms.
            </p>

            <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
              <Link
                href="/sign-up"
                className="inline-flex h-12 items-center justify-center rounded-full bg-white px-8 text-sm font-semibold text-zinc-900 shadow-lg shadow-white/10 transition-all hover:bg-zinc-100 active:scale-95"
              >
                Get Started Free
              </Link>
              <Link
                href="#"
                className="inline-flex h-12 items-center justify-center rounded-full border border-zinc-700 px-8 text-sm font-semibold text-zinc-300 transition-all hover:bg-zinc-800 active:scale-95"
              >
                Talk to Sales
              </Link>
            </div>
          ...
          <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-5">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="mt-4 max-w-xs text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
                Your intelligent personal agent that unifies Gmail, WhatsApp,
                Telegram, and Outlook into one powerful productivity hub.
              </p>
            </div>

            {/* Product */}
            <div>
              <h4 className="text-xs font-semibold uppercase tracking-widest text-zinc-500 dark:text-zinc-400">
                Product
              </h4>
