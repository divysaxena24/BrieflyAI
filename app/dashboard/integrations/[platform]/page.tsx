...
export default function PlatformSettingsPage() {
  ...
  const handleDisconnect = () => {
    void confirmAction({
      ...
      message:
        platformId === "whatsapp"
          ? "Disconnecting will stop BrieflyAI from accessing your WhatsApp until you reconnect."
          : `Disconnecting will stop BrieflyAI from accessing your ${integration.name} until you reconnect.`,
